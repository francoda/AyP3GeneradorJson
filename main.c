...
int main(int argc, char** argv) {
	...
	for (int i=0;i<argc;i++) {
		...
		if (!strcmp(argv[i],"-f") && i+1<argc) {
			...
			out = fopen(strcat(argv[0],argv[i+1]), "w");
		}
		if (!strcmp(argv[i],"-c")) {
		...
		if (!strcmp(argv[i],"-t")) {
			...
			char* size1 = "0 bytes";
			Njson nodo1;
			njson_init(&nodo1, "size", size1, sizeof(char*), 1, &njson_imprimir_string, false);
			...
			Njson nodo2;
			njson_init(&nodo2, "hash", hash, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo2);
			...
			Njson nodo5;
			njson_init(&nodo5, "rev", rev1, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo5);

			char* modified1 = "Wed, 27 Apr 2011 22:18:51 +0000";
			Njson nodo6;
			njson_init(&nodo6, "modified", modified1, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo6);

			char* path1 = "/Photos";
			Njson nodo7;
			njson_init(&nodo7, "path", path1, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo7);
			...
			char* icon1 = "folder";
			Njson nodo9;
			njson_init(&nodo9, "icon", icon1, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo9);

			char* root1 = "dropbox";
			Njson nodo10;
			njson_init(&nodo10, "root", root1, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo10);

			char* size2 = "2.3 MB";
			Njson nodo11;
			njson_init(&nodo11, "size", size2, sizeof(char*), 1, &njson_imprimir_string, false);

			char* rev2 = "38af1b183490";
			Njson nodo12;
			njson_init(&nodo12, "rev", rev2, sizeof(char*), 1, &njson_imprimir_string, false);
			...
			Njson nodo15;
			njson_init(&nodo15, "modified", modified2, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js2, &nodo15);

			char* client_mtime = "Thu, 29 Aug 2013 01:12:02 +0000";
			Njson nodo16;
			njson_init(&nodo16, "client_mtime", client_mtime, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js2, &nodo16);

			char* path2 = "/Photos/flower.jpg";
			Njson nodo17;
			njson_init(&nodo17, "path", path2, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo17);
			...
			Njson nodo19;
			njson_init(&nodo19, "time_taken", time_taken, sizeof(char*), 1, &njson_imprimir_string, false);
			...
			Njson nodo21;
			njson_init(&nodo21, "icon", icon2, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo21);

			char* root2 = "dropbox";
			Njson nodo22;
			njson_init(&nodo22, "root", root2, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo22);

			char* mime_type = "image/jpeg";
			Njson nodo23;
			njson_init(&nodo23, "mime_type", mime_type, sizeof(char*), 1, &njson_imprimir_string, false);
			json_add(&js, &nodo23);
